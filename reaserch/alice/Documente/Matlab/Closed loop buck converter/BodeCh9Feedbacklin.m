...
mdl = 'BuckFeedbackExampleCh9PID'; % set to file name of simulink model. Must have i/o points set within this model
...
ltiview('bode',-lin)   % send linearized model to LTI Viewer tool
sisotool(-lin)  % open sisotool